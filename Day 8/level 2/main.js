...
for (let user in users) {
  ...
  numberOfSkills.push(users[user].skills.length);
}

let maximumSkillNumber = numberOfSkills.sort((a, b) => a - b)[
  numberOfSkills.length - 1
];

// console.log(maximumSkillNumber);

for (const user in users) {
  if (users[user].skills.length === maximumSkillNumber) {
    userName = user;
    userInfo = users[user];
  }
}
...
console.log(
  `who has most skills\nName :${userName}\nNumber of skills :${userInfo.skills.length}\nSkills name :${userInfo.skills}`
);
...
console.log(
  `count logged in users : ${countLoggedIn}\ncount users having greater than equal to 50 points : ${countPoint}`
);
...
console.log(`MERN stack developer : ${mernDevelopers}`);
...
console.log(`Set your name without modifying the original users object`, users);

//5. Get all keys or properties of users object

let allKeys = Object.keys(users);
console.log(`all keys or properties of users object :`, allKeys);

//6. Get all the values of users object

let allValues = Object.values(users);
console.log(`all the values of users object :`, allValues);
